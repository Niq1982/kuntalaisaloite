...
** NOTE: ExportQTypes does not delete existing classes, thus if table, sequence or primary/foreign
   key names change, old classes need to be deleted by hand. It is easiest to empty aforementioned
   folder in *console* before generating new model.
...
TUPAS Test Credentials:

OP: 123456 / 7890 / anything
S-Pankki: 12345678 / 123456 / 1234
