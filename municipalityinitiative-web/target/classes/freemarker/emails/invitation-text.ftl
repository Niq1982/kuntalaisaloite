...
<#assign invitationUrlFi>${urlsFi.invitation(initiative.id,invitation.invitationCode)}</#assign>
<#assign invitationUrlSv>${urlsSv.invitation(initiative.id,invitation.invitationCode)}</#assign>
