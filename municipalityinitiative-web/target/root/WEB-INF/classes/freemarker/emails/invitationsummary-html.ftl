...
<@el.emailHtml "invitation-summary" titleFi>
    ...
    <@eb.emailTemplate "fi" titleFi>
        ...
        <p style="margin-top:0.5em;">Aloite löytyy toistaiseksi vain linkin kautta, eli jos tiedät sen osoitteen. Kun oikeusministeriö on tarkastanut aloitteen JA kannatusilmoituksia on kertynyt vähintään 50 kappaletta, aloitteesi tulee näkyviin myös Kansalaisaloite.fi-palvelun hakuihin.</p>
    ...
    <@eb.emailTemplate "sv" titleSv>      
        ...
        <p style="margin-top:0.5em;">Initiativet finns tillsvidare under direktlänken, men syns inte i initiativsökningen på medborgarinitiativ.fi. När justitieministeriet har granskat initiativet OCH minst 50 stödförklaringar har samlats in, syns ditt initiativ också bland sökningarna på tjänsten.</p>
