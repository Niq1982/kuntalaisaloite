...
<div id="wrapper">
    ...
    <div id="header-tools">
        <div id="header-tools-content">
            <div id="aloite-links">
                <a class="active" href="${urls.baseUrl}/${locale}">Kansalaisaloite.fi</a><span class="hide"> | </span><a href="${urls.infoIndex()}/<@u.message "InfoPage.MUNICIPALITY_INITIATIVE" />">Kuntalaisaloite.fi</a>
            </div>
        </div>
    </div>
