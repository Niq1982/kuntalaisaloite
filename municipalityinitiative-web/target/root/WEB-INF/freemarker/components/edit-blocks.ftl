...
<#macro blockHeader key edit="" disabled="">
    ...
    <div class="content-block-header ${(managementSettings.editMode == EditMode.NONE)?string('view','edit')}">
        ...
        <#-- Moved to basicDetails-block
        <#if key?contains("basicDetails") && (managementSettings.editMode == EditMode.FULL || managementSettings.editMode == EditMode.BASIC)>
            <div class="initiative-content-tools">          
                <a id="show-alternative-lang" class="small-button gray hidden" data-alttext="<@u.message "altVersion.hide" />" data-translation="${initiative.hasTranslation(altLocale)?string('true','false')}" ><span class="small-icon add"><@u.message "altVersion.add" /></span></a>
            </div>
        </#if>
         -->
    </div>    
    ...
    <div id="initiative-basic-details" class="input-block cf">
        ...
        <noscript>
            <div class="no-js-help-container">
                ...
                <#assign href>${urls.helpIndex()}/<@u.enumDescription HelpPage.INITIATIVE />#date</#assign>
 ...
 * Initiative keywords (TODO), financial support, support notifications, links 
 *
 * Prints help-texts and validation errors in this block
 -->
<#macro extraDetails>
    <div class="input-block cf">
        ...
        <noscript>
            <div class="no-js-help-container">
                <#--<@f.helpText "helpKeywords" "noscript" />-->
        ...
        <#-- TODO: Keywords
        <div class="input-block-content">
            <div class="initiative-header-area" style="opacity:0.5;">
                <@f.helpText "helpKeywords" />
                <label class="input-header">
                    <@u.message "initiative.keywords" /> <@u.icon type="required" size="small" />
                </label>
        ...
        <div class="input-block-content no-top-margin">    
            <div class="initiative-external-support-count js-hide">
                ...
                <@f.textField path="initiative.externalSupportCount" required="" cssClass="small" optional=false  maxLength=7 />
            </div>
        </div>
