...
<#assign invitationAcceptHtml>
    ...
    <form action="${springMacroRequestContext.requestUri}" method="POST" >
        ...
        <a href="${urls.confirmAcceptInvitation(initiative.id)}" class="small-button green green save-and-send"><span class="small-icon save-and-send"><@u.message "invitation.accept" /></span></a>
