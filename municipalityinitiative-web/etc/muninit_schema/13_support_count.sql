alter table municipality_initiative add column support_count_data text;
...
create table initiative_support_vote_day (
  ...
  constraint support_vote_day_initiative_id_fk foreign key (initiative_id) references municipality_initiative (id),
