...
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition) values ('SV', 'MAIN', 'anvisningar-for-deltagare', '', 'Anvisningar för deltagare i ett initiativ', 'Innehållet uppdateras', 'Innehållet uppdateras', 300);
