...
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition) values ('FI', 'MAIN', 'tietoa-kunnille', '', 'Tietoa kunnille', '', 'Sisältöä päivitetään paraikaa', 400);
...
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition, footer_display) values ('FI', 'KUNTALAISALOITE_FI', 'henkilotietojen-suoja-ja-tietoturva', '', 'Henkilötietojen suoja ja tietoturva', 'Sisältöä päivitetään paraikaa', 'Sisältöä päivitetään paraikaa', 700, true);
...
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition, footer_display) values ('FI', 'KUNTALAISALOITE_FI', 'yhteystiedot', '', 'Yhteystiedot', 'Sisältöä päivitetään paraikaa', 'Sisältöä päivitetään paraikaa', 900, true);
...
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition, footer_display) values ('FI', 'KUNTALAISALOITE', 'briefly-in-english', '', 'Briefly in english', 'The content is currently being updated', 'The content is currently being updated', 1400, true);
insert into info_text (languageCode, category, uri, published_subject, draft_subject, published, draft, orderPosition, footer_display) values ('SV', 'KUNTALAISALOITE', 'briefly_in_english', '', 'Briefly in english', 'The content is currently being updated', 'The content is currently being updated', 1400, true);
