...
public class QSupportVoteBatch extends com.mysema.query.sql.RelationalPathBase<QSupportVoteBatch> {
    ...
    private static final long serialVersionUID = 296049329;
    ...
    public QSupportVoteBatch(String variable) {
        super(QSupportVoteBatch.class, forVariable(variable), "municipalityinitiative", "support_vote_batch");
    }

    public QSupportVoteBatch(Path<? extends QSupportVoteBatch> path) {
        super(path.getType(), path.getMetadata(), "municipalityinitiative", "support_vote_batch");
    }

    public QSupportVoteBatch(PathMetadata<?> metadata) {
        super(QSupportVoteBatch.class, metadata, "municipalityinitiative", "support_vote_batch");
    }
