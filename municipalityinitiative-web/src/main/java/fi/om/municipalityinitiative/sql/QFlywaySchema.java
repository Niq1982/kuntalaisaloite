...
public class QFlywaySchema extends com.mysema.query.sql.RelationalPathBase<QFlywaySchema> {
    ...
    private static final long serialVersionUID = 1368929709;
    ...
    public QFlywaySchema(Path<? extends QFlywaySchema> path) {
        super(path.getType(), path.getMetadata(), "municipalityinitiative", "flyway_schema");
        addMetadata();
    }

    public QFlywaySchema(PathMetadata<?> metadata) {
        super(QFlywaySchema.class,  metadata, "municipalityinitiative", "flyway_schema");
        addMetadata();
    }
