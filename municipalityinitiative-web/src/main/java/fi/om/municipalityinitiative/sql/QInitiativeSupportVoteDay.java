...
public class QInitiativeSupportVoteDay extends com.mysema.query.sql.RelationalPathBase<QInitiativeSupportVoteDay> {
    ...
    private static final long serialVersionUID = 1036012031;
    ...
    public final com.mysema.query.sql.ForeignKey<QMunicipalityInitiative> supportVoteDayInitiativeIdFk = createForeignKey(initiativeId, "id");

    public QInitiativeSupportVoteDay(String variable) {
        super(QInitiativeSupportVoteDay.class,  forVariable(variable), "municipalityinitiative", "initiative_support_vote_day");
        addMetadata();
    }

    public QInitiativeSupportVoteDay(Path<? extends QInitiativeSupportVoteDay> path) {
        super(path.getType(), path.getMetadata(), "municipalityinitiative", "initiative_support_vote_day");
        addMetadata();
    }

    public QInitiativeSupportVoteDay(PathMetadata<?> metadata) {
        super(QInitiativeSupportVoteDay.class,  metadata, "municipalityinitiative", "initiative_support_vote_day");
        addMetadata();
    }
