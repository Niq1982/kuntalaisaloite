...
import static fi.om.municipalityinitiative.web.Urls.ACTION_SEND_TO_VRK;
import static fi.om.municipalityinitiative.web.Urls.ACTION_VOTE;
import static fi.om.municipalityinitiative.web.Urls.ACTION_REMOVE_SUPPORT_VOTES;
import static fi.om.municipalityinitiative.web.Urls.DOWNLOAD_VOTES;
import static fi.om.municipalityinitiative.web.Urls.VIEW_FI;
import static fi.om.municipalityinitiative.web.Urls.VIEW_SV;
import static fi.om.municipalityinitiative.web.Views.VOTE_VIEW;
...
import fi.om.municipalityinitiative.dto.InitiativePublic;
...
//            return redirect(urls.view(initiativeId));
        } else {
    ...
    public String sendToVRKPost(@PathVariable("id") Long initiativeId, Model model, Locale locale, HttpServletRequest request) {
        ...
        // XXX Does user need exact batch size?
