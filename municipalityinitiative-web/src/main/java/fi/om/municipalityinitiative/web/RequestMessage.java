...
public enum RequestMessage {
    ...
    INITIATIVE_DELETED (SUCCESS),
    INITIATIVE_RESTORED (SUCCESS),
    CONFIRM_INVITATION_ACCEPTED (SUCCESS),
    CONFIRM_INVITATION_REJECTED (SUCCESS),
    PARTICIPANT_DELETED (SUCCESS),
    COMFIRM_FOLLOW(SUCCESS),
    COMFIRM_STOP_FOLLOW(SUCCESS),
    FAILED_STOP_FOLLOW(WARNING),
