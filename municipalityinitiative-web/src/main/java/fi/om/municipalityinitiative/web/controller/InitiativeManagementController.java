...
public class InitiativeManagementController extends BaseController {
    ...
    private void validateVideoUrl(String videoUrl, BindingResult bindingResult) {
        if ((videoUrl!= null && !videoUrl.equals("")) && !videoUrl.matches(VideoService.VIDEO_REGEX)) {
            bindingResult.addError(new FieldError("updateData", "videoUrl", videoUrl, false, new String[]{"invalidUrl"}, new String[]{"invalidUrl"}, ""));
        }
    }
