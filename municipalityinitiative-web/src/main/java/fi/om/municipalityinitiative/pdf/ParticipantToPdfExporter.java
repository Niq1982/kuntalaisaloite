...
public class ParticipantToPdfExporter {
    ...
    private Maybe<List<Participant>> participants = Maybe.absent();

    public ParticipantToPdfExporter(Initiative initiative) {
        this.initiative = initiative;
    }

    public ParticipantToPdfExporter(Initiative initiative, List<Participant> participants) {
        this.initiative = initiative;
        this.participants = Maybe.of(participants);
    }
    ...
    private void addParticipants() throws DocumentException {
        ...
        createTable(preface, participants.get());
