...
public class TestDataTemplateTexts {
    static final String INITIATIVE_1_NAME = "Kansalaisaloite kansalaisaloitepäivästä ja sen viettämisestä yleisenä juhla- ja vapaapäivänä";
    static final String INITIATIVE_1_PROPOSAL =
    ...
    static final String INITIATIVE_1_RATIONALE = 
    ...
    static final String INITIATIVE_2_NAME = "Laki turvekepaketoinnin kieltämiseksi";
    static final String INITIATIVE_2_PROPOSAL = 
    ...
    static final String INITIATIVE_2_RATIONALE = 
