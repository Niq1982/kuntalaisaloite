                    ...
                    <div class="front-block block-2 noprint">
                        ...
                        <div class="flat-style">
                            ...
                            <input type="hidden" name="show" value="all"/>
                                <select name="municipalities" id="municipality" class="chzn-select municipality-filter" data-initiative-municipality="" data-placeholder="<@u.message "front.browse.choose" />">
