            ...
            <div class="content choose-type-section top-pad cf">
                ...
                <div class="c-group c-group-1 cf">
                    <div class="span span-1">
                        <h4><@u.messageHTML  "infoGraph.choose.type.COLLABORATIVE.title" /></h4>
                    </div>
                    <div class="span span-1">
                        <h4><@u.messageHTML  "infoGraph.choose.type.COLLABORATIVE_COUNCIL.title.mobile" /></h4>
                    </div>
                    <div class="span span-1">
                        <h4><@u.messageHTML  "infoGraph.choose.type.COLLABORATIVE_CITIZEN.title.mobile" /></h4>
                    </div>
