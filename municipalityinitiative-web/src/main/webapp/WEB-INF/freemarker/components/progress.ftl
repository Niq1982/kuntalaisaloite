...
<#macro progress initiative public=true omOrMunicipality=false>
	...
	<#assign isMunicipalityDecision = decisionInfo?? && decisionInfo.present/>
    ...
    <#assign sendToMunicipality><@u.message "progress.public.sent" /><#if initiative.sentTime.present><br/><@u.localDate initiative.sentTime.get() /></#if></#assign>
	<#assign municipalityDecision><@u.message "progress.public.decision"/><br/><#if initiative.getDecisionDate().present><@u.localDate initiative.getDecisionDate().get() /></#if>
		<#if initiative.getDecisionModifiedDate().present><br/><@u.message "progress.public.decision.modified"/><br/><@u.localDate initiative.getDecisionModifiedDate().get() /></#if></#assign>
