...
<div id="aloite-links">
    ...
    <a href="https://www.kansalaisaloite.fi/${locale}"><@u.message "otherServices.initiative"/></a><span class="hide"> | </span>
    <a class="active" href="${urls.baseUrl}/${locale}"><@u.message "otherServices.municipalityinitiative"/></a><span class="hide"> | </span>
