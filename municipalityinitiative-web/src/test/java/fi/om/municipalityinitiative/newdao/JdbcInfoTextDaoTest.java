...
public class JdbcInfoTextDaoTest {
    ...
    public static final InfoTextCategory INFO_TEXT_CATEGORY = InfoTextCategory.KUNTALAISALOITE;
    ...
    public void get_om_list_returns_all_with_given_language_ordered_by_orderPosition() {
        testHelper.dbCleanup();
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 10, "uri1", null, null, null, null, null, null);
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 11, "uri2", "", "", "", "", null, "");
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 9, "uri3", "t", "t", "t", "t", null, "");
    ...
    public void get_om_list_returns_only_links_with_given_language() {
        testHelper.dbCleanup();
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 10, "finnish_uri", "text", "text", "text", "text", new DateTime(), "name");
        testHelper.createInfoText(LanguageCode.SV, InfoTextCategory.KUNTALAISALOITE, 10, "swedish_uri", "text", "text", "text", "text", new DateTime(), "name");
    ...
    public void get_public_list_returns_only_links_ordered_by_orderPosition() {
        testHelper.dbCleanup();
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 10, "uri1", "t", "t", "t", "t", null, null);
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 11, "uri2", "t", "t", "t", "t", null, null);
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 9, "uri3", "t", "t", "t", "t", null, "");
    ...
    public void get_public_list_returns_only_links_which_have_no_null_or_empty_text() {
        testHelper.dbCleanup();
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 1, "1", "","",  "", "draftText", DateTime.now(), "name");
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 2, "2", null,null, null, "draftText", DateTime.now(), "name");
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 3, "3", "t", "t", null, "draftText", DateTime.now(), "name");
        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 5, "4", null, null, "t", "draftText", DateTime.now(), "n");

        testHelper.createInfoText(LanguageCode.FI, InfoTextCategory.KUNTALAISALOITE, 4, "5", "t", "t", "t", "draftText", DateTime.now(), "n");
