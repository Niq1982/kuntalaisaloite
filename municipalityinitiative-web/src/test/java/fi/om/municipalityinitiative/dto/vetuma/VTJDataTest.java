...
public class VTJDataTest {
    ...
    private final String MSG_KEY_MISSING_MUNICIPALITY = "VTJData.missingMunicipality";
    private String missingMunicipalityNameFi = null; // "Kotikunta ei tiedossa";
    private String missingMunicipalityNameSv = null; // "På svenska: Kotikunta ei tiedossa";
    
    @Before
    public void init() {
        missingMunicipalityNameFi = messageSource.getMessage(MSG_KEY_MISSING_MUNICIPALITY, null, Locales.LOCALE_FI); 
        missingMunicipalityNameSv = messageSource.getMessage(MSG_KEY_MISSING_MUNICIPALITY, null, Locales.LOCALE_SV);
    }
    ...
    public void Parse_HST_Card_Missing_Municipality_Test_Data() {
        ...
        VTJData vtjData = VTJData.parse(xml, messageSource);
