...
import static fi.om.municipalityinitiative.dto.ManagementSettingsTest.ManagementSettingsBuilder.ConfirmStatus.CONFIRMED;
import static fi.om.municipalityinitiative.dto.ManagementSettingsTest.ManagementSettingsBuilder.ConfirmStatus.UNCONFIRMED;
...
public class ManagementSettingsTest  {
    ...
    // - - - - - - - - - -
    //     allowRemoveSupportVotes
    // - - - - - - - - - -

    // - - - - - - - - - -
    //    extraWarningforRemoveSupportVotes
    // - - - - - - - - - -
    ...
    static class ManagementSettingsBuilder {
        ...
        enum ConfirmStatus { CONFIRMED, UNCONFIRMED }

        static ManagementSettingsBuilder withInitiativeId(Long id) {return new ManagementSettingsBuilder(id); }

        ManagementSettingsBuilder withIsAuthor(ConfirmStatus confirmStatus) {
        ...
        ManagementSettingsBuilder withInitiativeState(InitiativeState initiativeState) {
            initiative.assignState(initiativeState);
            return this;
        }

        ManagementSettingsBuilder withEditMode(EditMode editMode) {
            this.editMode = editMode;
            return this;
        }

        ManagementSettingsBuilder withIsOmUser() {
            currentUser = new User(null, null, null, null, null, false, true);
            assert(currentUser.isOm());
            return this;
        }

        ManagementSettingsBuilder withIsVRKUser() {
            currentUser = new User(null, null, null, null, null, true, false);
            assert(currentUser.isVrk());
            return this;
        }

        ManagementSettingsBuilder withIsOmVRKUser() {
        ...
        ManagementSettingsBuilder withIsDefaultUser() {
            currentUser = new User();
            return this;
        }


        ManagementSettingsBuilder withUnsetInvitations(int unsetInvitations) {
        ...
        ManagementSettingsBuilder withPendingConfirmationReminders(int reminders) {
            initiative.pendingConfirmationReminders = reminders;
            return this;
        }

        ManagementSettingsBuilder withIsEnoughConfirmedAuthors(boolean isEnough) {
            initiative.enoughConfirmedAuthors = isEnough;
            return this;
        }

        ManagementSettingsBuilder withSupportCount(int supportCount) {
            initiative.assignSupportCount(supportCount);
            return this;
        }

        ManagementSettingsBuilder withSupportStatementsRemoved(DateTime removeTime) {
            initiative.assignSupportStatementsRemoved(removeTime);
            return this;
        }

        ManagementSettingsBuilder withSentSupportCount(int sentSupportCount) {
        ...
        private ManagementSettingsBuilder(Long initiativeId) {
